...
class K_Means:
    def __init__(self, k=20, tol=0.001, max_iter=300):
...
original_image = cv2.imread('scarlet_tanager.jpg',  cv2.IMREAD_COLOR)
...
img_gray=Image.open('scarlet_tanager.jpg').convert('L')
img_gray.show()
